...
What would've happened if we bought in during those fear-filled drawdowns? Let's take a look at the returns for each drawdown category (dd_cat) over the next 20, 50, 100, and 200 days:
