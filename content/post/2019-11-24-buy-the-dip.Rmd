...
With all our drawdowns calculated, let's break those down into categories -- how much sell off should you wait for before buying in?:
* -1% to -5%
* -5% to -10%
* -10% to -20%
* < -20%
...
Would ya look at that: returns in each drawdown category (dd_cat) are **positive** over the next 20, 50, 100, and 200 trading days from drawdown.
...
Obviously we can't know a drawdown actually falls into one of those categories until the next ATH is in place. But the take aways is that "buying the dip", buying into fear, can produce optimistic results. While it would be hard to get in at a "3 % correct" only for prices to sell off and additional 50%, as long as you keep buying in, the long term looks promising.
